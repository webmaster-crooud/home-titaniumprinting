...
export default function ProductsDetail({ data }: { data: Data }) {
...
export const getServerSideProps: GetServerSideProps = async (ctx: GetServerSidePropsContext) => {
    ...
    try {
        ...
        const responseCategories = await fetch(`${BACKEND}/categories`);
        const resultCategories = await responseCategories.json();
        const categories: Categories[] = resultCategories.data;
